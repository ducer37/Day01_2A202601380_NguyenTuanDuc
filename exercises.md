...
> Qua 4 mức temperature, em nhận thấy: T=0.0: Phản hồi rất an toàn, cứng nhắc và có phần lặp lại. T=0.7: Văn phong tự nhiên và sáng tạo hơn. T=1.2: Từ ngữ bay bổng, có phần cường điệu hơn. T=1.8: Văn bản bắt đầu kém mạch lạc, ngữ pháp lỗi nghiêm trọng (vd: "Hoa sữa xe máy vù vù rồng bay thủ đô nước lóng lánh phố phường bát ngát!"). Số temperature càng cao thì AI càng dùng từ ngữ phong phú, nhưng từ mức 1.2 và đặc biệt là 1.8, phản hồi bị suy giảm chất lượng rõ rệt, trở nên kém mạch lạc và lỗi ngữ pháp nặng nề và có khả năng bị hallucination.
